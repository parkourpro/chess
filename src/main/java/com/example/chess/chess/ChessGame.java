...
import com.example.chess.chess.localization.Localization;
import com.example.chess.chess.online.ChessOnlineConnection;
import com.example.chess.chess.online.ChessServer;
import com.example.chess.chess.online.ClientOnlineConnection;
...
public class ChessGame extends Application
{
    ...
    public void showPawnReplacementWindow(Side side, final ChessBoard.Tile tile)
    {
        ...
        if (side == Side.BLACK)
        {
            queen.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-queen-50.png")));
            rook.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-rook-50.png")));
            bishop.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-bishop-50.png")));
            knight.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-knight-50.png")));
        }
        else
        {
            queen.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-queen-50-white.png")));
            rook.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-rook-50-white.png")));
            bishop.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-bishop-50-white.png")));
            knight.setFill(new ImagePattern(new Image("com/example/chess/icons/icons8-knight-50-white.png")));
        }
